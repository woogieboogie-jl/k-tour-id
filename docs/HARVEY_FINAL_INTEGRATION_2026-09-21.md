...
**9/24 후속:** [보존 통합·독립 회귀 검증](./HARVEY_PRESERVATION_INTEGRATION_2026-09-24.md)에서 아래 outbox 결함과 문서 왕복/Back 복귀 문제를 보완했습니다. 아래 수치·미수정 표시는 9/21 당시 기록이며 최신 판단은 9/24 보고서를 따릅니다.
