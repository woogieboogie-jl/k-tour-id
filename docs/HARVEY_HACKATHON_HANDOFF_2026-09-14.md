...
**9/17 로컬 통합 업데이트:** Harvey의 `b151c745`와 후속 `84254d24`를 기존 모바일 후속본과 `integration/harvey-sync-20260917`에 통합합니다. 미푸시·미배포이며 실연동 완료가 아닙니다. 현재 Harvey의 혜택 사용 v1과 아래 가이드 저장 v2의 계약은 아직 다릅니다. 실행 방법·격리 검수·남은 Sui/OpenDID 작업은 [로컬 통합 기록](./HARVEY_SYNC_LOCAL_2026-09-17.md)을 우선 확인하세요.
